...
function InventoryPage() {
  ...
  return (
    <div className="d-flex min-vh-100 bg-light">
      <Sidebar activeItem="Part/Inventory" />
      <main
        ...
        <section className="card border-0 shadow-sm">
          ...
          <div className="table-responsive">
            <table className="table table-hover align-middle mb-0">
              ...
              <tbody>
                {loading ? <tr><td colSpan={5} className="text-center text-secondary py-5"><span className="spinner-border spinner-border-sm me-2" />Loading inventory...</td></tr> : error ? <tr><td colSpan={5} className="text-center text-danger py-5">{error}</td></tr> : visibleParts.length ? visibleParts.map((part) => (
                  <tr key={part.sku}>
                ...
                )) : <tr><td colSpan={5} className="text-center text-secondary py-5">No inventory parts found.</td></tr>}
              </tbody>
            </table>
          </div>
