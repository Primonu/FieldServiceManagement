                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-12 col-md-6">
                      <label className="form-label fw-medium small">Site Name *</label>
                      <input
                        type="text"
                        name="siteName"
                    ...
                    <div className="col-12 col-md-6">
                      <label className="form-label fw-medium small">Apartment / Building</label>
                      <input
                        type="text"
                        name="appartmentName"
                        className="form-control"
                    ...
                    <div className="col-12 col-md-6">
                      <label className="form-label fw-medium small">Floor No</label>
                      <input
                        type="text"
                        name="floorNo"
                        className="form-control"
                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-12">
                      <label className="form-label fw-medium small">Address Details *</label>
                      <input
                        type="text"
                        name="addressDetails"
                        className="form-control"
                    ...
                    <div className="col-12 col-md-6 col-lg-3">
                      <label className="form-label fw-medium small">Country</label>
                      <input
                        type="text"
                        name="country"
                        className="form-control"
                    ...
                    <div className="col-12 col-md-6 col-lg-3">
                      <label className="form-label fw-medium small">Zip Code</label>
                      <input
                        type="number"
                        name="zipCode"
                        className="form-control"
