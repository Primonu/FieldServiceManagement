                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        ...
                        <input id="address" type="text" className="form-control" value={formData.address} onChange={(event) => handleChange('address', event.target.value)} placeholder="e.g. 123 Main St, City, State" required />
                      </div>
                      <div className="col-md-6">
                        <label htmlFor="active" className="form-label small fw-semibold text-dark">Active Customer</label>
                        <input id="active" type="checkbox" className="form-check-input" checked={formData.active} onChange={(event) => handleChange('active', event.target.checked)} />
                      </div>
                    </div>

                    <div className="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                      <button type="button" onClick={() => navigate('/Manager/Customers')} className="btn btn-outline-secondary">Cancel</button>
