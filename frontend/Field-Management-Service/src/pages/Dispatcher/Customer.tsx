  ...
  return (
    <div className="dashboard-app">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <button type="button" onClick={() => navigate('/Dispatcher/AddCustomer')} className="btn btn-dark px-3" style={{ backgroundColor: "#0B192C" }}>
          + Add Customer
        </button>
      </div>
      ...
      <div className="card border-0 shadow-sm p-3">
        <div className="card-body">
            ...
            <table className="table align-middle text-nowrap">
              ...
              <tbody>
                ...
                {!loading && !error && filteredCustomers.length === 0 &&(
                  <tr>
                    <td colSpan={7} className="text-center text-muted py-4">No Customer found</td>
                  </tr>
                )}
                  ...
                  <tr key={customer.id}>
                    ...
                    <td className="text-end">
                      <button className="btn btn-link text-muted p-0 border-0"
                       onClick={() => navigate(`/Dispatcher/EditCustomer/${encodeURIComponent(customer.id)}`)} >
          ...
          <div className="d-flex justify-content-between align-items-center mt-3 pt-2">
            <span className="text-muted small">Showing 1 to 5 of 45 entries</span>
